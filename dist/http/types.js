...
exports.eventSchema = zod_1.default.object({
    ...
    vip_tickets_count: zod_1.default.number().min(0, "VIP ticket count must be at least 0"),
    general_ticket_price: zod_1.default.number().min(0, "General ticket price must be at least 0"),
    general_tickets_count: zod_1.default.number().min(0, "General ticket count must be at least 0"),
